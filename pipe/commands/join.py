...
if TYPE_CHECKING:
    from syntax_tree.nodes import PipeCommandNode, CommandAST
...
class JoinCommand(PipeCommand):
    ...
    def _parse_from_ast(self) -> None:
        ...
        from syntax_tree.nodes import PositionalArgumentNode, IdentifierNode
    ...
    def _execute_subquery(self) -> pd.DataFrame:
        ...
        from executors import SubqueryExecutor
