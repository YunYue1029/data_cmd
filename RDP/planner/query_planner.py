...
if TYPE_CHECKING:
    from RDP.syntax_tree.nodes import CommandAST, PipeCommandNode
...
class QueryPlanner:
    ...
    def __init__(self):
        from RDP.planner.optimizers import FilterOptimizer, HeadOptimizer
        self.optimizers = [
            FilterOptimizer(),
            HeadOptimizer(),
        ]
    ...
    def create_commands(self, plan: ExecutionPlan) -> list["PipeCommand"]:
        ...
        """
        from RDP.pipe.services import PipeCommandFactory
